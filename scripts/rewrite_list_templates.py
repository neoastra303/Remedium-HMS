...
TEMPLATES = {
    "surgery/templates/surgery/surgery_list.html": {
        ...
        "icon": "bi-scissors",
        "ctx": "surgeries",
        "create_url": "surgery_create",
        "create_label": "Schedule Surgery",
        ...
        "for_var": "surgery",
        "empty_icon": "bi-scissors",
        "empty_msg": "No surgeries scheduled.",
    },
    "staff/templates/staff/staff_list.html": {
        "title": "Staff",
        "icon": "bi-person-badge",
        "ctx": "staff_list",
        "create_url": "staff_create",
        "create_label": "Add Staff",
        ...
        "for_var": "member",
        "empty_icon": "bi-person-badge",
        "empty_msg": "No staff members found.",
    },
    "appointments/templates/appointments/appointment_list.html": {
        "title": "Appointments",
        "icon": "bi-calendar-event",
        "ctx": "appointments",
        "create_url": "appointment_create",
        "create_label": "Book Appointment",
        ...
        "empty_msg": "No appointments scheduled.",
    },
    "laboratory/templates/laboratory/labtest_list.html": {
        "title": "Lab Tests",
        "icon": "bi-microscope",
        "ctx": "lab_tests",
        "create_url": "labtest_create",
        "create_label": "Order Test",
        ...
        "for_var": "test",
        "empty_icon": "bi-microscope",
        "empty_msg": "No lab tests ordered.",
    },
    "pharmacy/templates/pharmacy/prescription_list.html": {
        "title": "Prescriptions",
        "icon": "bi-capsule",
        "ctx": "prescriptions",
        "create_url": "prescription_create",
        "create_label": "New Prescription",
        ...
        "for_var": "prescription",
        "empty_icon": "bi-capsule",
        "empty_msg": "No prescriptions found.",
    },
    "inventory/templates/inventory/inventoryitem_list.html": {
        "title": "Inventory",
        "icon": "bi-box-seam",
        "ctx": "inventory_items",
        "create_url": "inventoryitem_create",
    ...
    "care_monitoring/templates/care_monitoring/patientcare_list.html": {
        ...
        "icon": "bi-heart-pulse",
        "ctx": "patientcares",
        "create_url": "care_monitoring:patientcare_create",
        "create_label": "New Record",
        ...
        "for_var": "patientcare",
        "empty_icon": "bi-heart-pulse",
        "empty_msg": "No care records found.",
    },
    "reporting/templates/reporting/report_list.html": {
        "title": "Reports",
        "icon": "bi-bar-chart",
        "ctx": "reports",
        "create_url": "report_generate",
        ...
        "for_var": "report",
        "empty_icon": "bi-bar-chart",
        "empty_msg": "No reports generated yet.",
    },
    "integration/templates/integration/integration_list.html": {
        "title": "Integrations",
        "icon": "bi-plug",
        "ctx": "integrations",
        "create_url": "integration_create",
        "create_label": "Add Integration",
        ...
        "for_var": "integration",
        "empty_icon": "bi-plug",
        "empty_msg": "No integrations configured.",
    },
}
...
for path, cfg in TEMPLATES.items():
    ...
    content = TEMPLATE.format(
        icon=cfg["icon"],
        title=cfg["title"],
        create_url=cfg["create_url"],
        create_label=cfg["create_label"],
