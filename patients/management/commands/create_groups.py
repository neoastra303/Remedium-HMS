    ...
    def handle(self, *args, **kwargs):
        ...
        for group_name in groups_to_create:
            ...
            if group_name == "Doctor":
                ...
                for perm in permissions:
                    try:
                        ...
                        self.stdout.write(
                            self.style.WARNING(f"Permission '{perm}' not found.")
                        )
                self.stdout.write(
                    self.style.SUCCESS(
                        f"Successfully assigned permissions to '{group_name}' group."
                    )
                )
            ...
            if group_name == "Administrator":
                ...
                self.stdout.write(
                    self.style.SUCCESS(
                        f"Successfully assigned all permissions to '{group_name}' group."
                    )
                )
