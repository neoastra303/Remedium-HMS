...
@extend_schema_view(
    list=extend_schema(summary="List all patients", description="Retrieve a paginated list of all patients in the system."),
    retrieve=extend_schema(summary="Get patient details", description="Retrieve detailed information about a specific patient by ID."),
    create=extend_schema(summary="Register new patient", description="Create a new patient record in the system."),
    update=extend_schema(summary="Update patient", description="Update all fields of an existing patient record."),
    partial_update=extend_schema(summary="Partial update patient", description="Update specific fields of an existing patient record."),
    destroy=extend_schema(summary="Delete patient", description="Permanently remove a patient record from the system."),
)
