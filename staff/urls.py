...
urlpatterns = [
    ...
    path(
        "staff/<int:pk>/delete/", views.StaffDeleteView.as_view(), name="staff_delete"
    ),
    path("staff/<int:pk>/", views.StaffDetailView.as_view(), name="staff_detail"),
    path(
        "staff/<int:staff_pk>/shifts/add/",
        views.ShiftCreateView.as_view(),
        name="shift_create",
    ),
    path(
        "shifts/<int:pk>/delete/", views.ShiftDeleteView.as_view(), name="shift_delete"
    ),
