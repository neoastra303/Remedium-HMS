...
### Added
- add pagination to document list, create encounter detail template ([`31aab67`])
...
### Changed
- remove stale templates and unused JS modules ([`9a4012d`])
- remove dead code from integration views ([`ed1463d`])
...
- correct permission name in check_in_appointment view ([`27428c9`])
