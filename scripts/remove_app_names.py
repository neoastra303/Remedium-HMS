...
apps = [
    'appointments', 'billing', 'care_monitoring', 'core', 'hospital',
    'integration', 'inventory', 'laboratory', 'medical_records',
    'notifications', 'patients', 'pharmacy', 'reporting', 'staff', 'surgery',
]
